...
processor_1['couchdb-admin-password'] = 'admin'
processor_1['couchdb-address'] = '127.0.0.1:5984/'
...
processor_2['couchdb-admin-password'] = 'admin'
processor_2['couchdb-address'] = '127.0.0.1:5984/'
...
processor_3['couchdb-admin-password'] = 'admin'
processor_3['couchdb-address'] = '127.0.0.1:5984/'
